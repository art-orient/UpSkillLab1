...
public class Main {
    public static void main(String[] args) {
        ...
        String str1 = "Few of us like to be told we are average. Americans are no exception. Generalizations about nationalities (like, Americans are optimists, or Germans are professional pessimists) are not usually welcomed, even if they are truthful.\n" +
                "\n" +
        ...
        System.out.println(Task1.sortParagraphs(str1));
        System.out.println("____________________________________\n");
        System.out.println(Task1.sortWordLength(str1));
        System.out.println("____________________________________\n");
        System.out.println(Task1.sortSumChar(str1));
